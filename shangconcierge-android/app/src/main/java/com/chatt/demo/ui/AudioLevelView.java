...
public class AudioLevelView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(R.color.main_color_gray_dk));
//        mPaint.setColor(getResources().getColor(com.opentok.android.demo.opentoksamples.R.color.black_grey));
        ...
        mPaintGradient.setColor(getResources().getColor(R.color.main_color_gray));
 //         mPaintGradient.setColor(getResources().getColor(com.opentok.android.demo.opentoksamples.R.color.init_gradient));
   ...
   //    mPaintGradient.setShader(new RadialGradient(w / 2, h / 2, h / 2,
     //          getResources().getColor(com.chatt.demo.ui.R.color.color0_gradient), getResources().getColor(com.chatt.demo.ui.R.color.color1_gradient), TileMode.CLAMP));

        mPaintGradient.setShader(new RadialGradient(w / 2, h / 2, h / 2,
                getResources().getColor(R.color.gray_light), getResources().getColor(R.color.gray_light), TileMode.CLAMP));
