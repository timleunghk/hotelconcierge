...
var _ = require('../underscore.js')._,
    sax = require('../cloud/opentok/sax.js'),
    Base64 = require('../cloud/opentok/Base64.js'),
    CryptoJS = require('../cloud/opentok/CryptoJS.js'),
    xml2js = require('../cloud/opentok/xml2js.js'),
    events = require('../cloud/opentok/events.js');
...
OpenTokSDK.prototype.generateToken = function(sessionId, options) {
  ...
  params = _.defaults(options, {
    ...
    "role" : ROLE.MODERATOR, //ROLE.PUBLISHER,
    "connection_data" : '',
